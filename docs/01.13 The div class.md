...
All engine functionality is provided through the div class. If your project already defines a class named div, you can rename the Div class or use a namespace alias.
